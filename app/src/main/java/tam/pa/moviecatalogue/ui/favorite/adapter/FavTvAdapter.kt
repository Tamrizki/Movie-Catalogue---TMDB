...
class FavTvAdapter(
...
): PagedListAdapter<TvSeries, FavTvAdapter.ViewHolder>(DIFF_CALLBACK) {
        ...
        fun bind(tv: TvSeries) {
            with(binding){
                ...
                Glide.with(itemView.context)
                        .load(ApiConfig.BASE_URL_IMAGE+tv.backdropPath)
    ...
    fun getSwipeData(swipedPosition: Int): TvSeries? = getItem(swipedPosition)
}