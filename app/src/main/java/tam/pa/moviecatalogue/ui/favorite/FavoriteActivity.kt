...
class FavoriteActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerviewTv(tv: PagedList<TvSeries>?) {
        tvAdapter = FavTvAdapter(object : FavTvAdapter.OnAdapterListener{
            override fun OnClick(serialTv: TvSeries) {
    ...
    private fun setupRecyclerviewMovie(listMovie: PagedList<Movie>?) {
    ...
    private val itemTouchHelperMovie = ItemTouchHelper(object : ItemTouchHelper.Callback(){
        ...
        override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
            ...
            val movie = movieAdapter.getSwipeData(swipedPosition)
            movie?.let {
    ...
    private val itemTouchHelperTv = ItemTouchHelper(object : ItemTouchHelper.Callback(){
        ...
        override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
            val swipedPosition = viewHolder.adapterPosition
            val tv = tvAdapter.getSwipeData(swipedPosition)
            tv?.let {
